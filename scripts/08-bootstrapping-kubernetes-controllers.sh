...
echo "Creating the kube-apiserver.service systemd unit file"
...
echo "Creating the kube-controller-manager.service systemd unit file"
...
echo "Installing a basic web server to handle HTTP health checks"
...
echo "Testing the nginx HTTP health check proxy"
